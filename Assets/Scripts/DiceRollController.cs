...
public class DiceRollController : MonoBehaviour
{
    ...
    private void SetScale(float input)
    {
        ...
        for (int i = 0; i < spawnedDice.Count; i++)
        {
            spawnedDice[i].mainDice.SetScale(Mathf.Lerp(0.7f, 0.3f, t), Mathf.Lerp(1.2f,0.7f, t));
            spawnedDice[i].CloneDice.SetScale(Mathf.Lerp(0.7f, 0.3f, t), Mathf.Lerp(1.2f, 0.7f, t));
        }
    }
